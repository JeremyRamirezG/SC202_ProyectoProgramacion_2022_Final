 ...
 * @author jrg71
 */
public class frm_Clientes_AgregarVerduras extends javax.swing.JFrame {

    /**
     * Creates new form frm_Clientes_AgregarVerduras
     */
    public frm_Clientes_AgregarVerduras() {
        initComponents();
        poblarTablaVerduras();
    }
    ...
    private void initComponents() {
        ...
        lblImagenVegetales = new javax.swing.JLabel();
        jScrollPane1 = new javax.swing.JScrollPane();
        tblVegetales = new javax.swing.JTable();
        ...
        lblVegetales.setFont(new java.awt.Font("Eras Bold ITC", 0, 24)); // NOI18N
        lblVegetales.setForeground(new java.awt.Color(26, 77, 46));
        lblVegetales.setText("Sección de Vegetales");

        lblImagenVegetales.setIcon(new javax.swing.ImageIcon(getClass().getResource("/contents/verduras.png"))); // NOI18N

        tblVegetales.setBackground(new java.awt.Color(26, 77, 46));
        tblVegetales.setFont(new java.awt.Font("Eras Demi ITC", 0, 12)); // NOI18N
        tblVegetales.setForeground(new java.awt.Color(0, 0, 0));
        tblVegetales.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Vegetal", "ID Vegetal", "Precio", "Cantidad"
            }
        ));
        tblVegetales.setGridColor(new java.awt.Color(26, 77, 46));
        tblVegetales.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblVegetalesMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tblVegetales);
        ...
        txtCantidadResultado.setFont(new java.awt.Font("Eras Medium ITC", 0, 12)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(lblImagenVegetales)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void tblVegetalesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblVegetalesMouseClicked
        // TODO add your handling code here:
        int filaSeleccionada = tblVegetales.rowAtPoint(evt.getPoint());
        
        lblNombreResultado.setText(tblVegetales.getValueAt(filaSeleccionada, 0).toString());
        lblIDResultado.setText(tblVegetales.getValueAt(filaSeleccionada, 1).toString());
        lblPrecioResultado.setText(tblVegetales.getValueAt(filaSeleccionada, 2).toString());
        lblCantidadDisponibleResultado.setText(tblVegetales.getValueAt(filaSeleccionada, 3).toString());
    }//GEN-LAST:event_tblVegetalesMouseClicked
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        if((isNumeric(cantidadAgregada)&&isNumeric(cantidadDisponible)&&isDouble(precio))){
            ...
            if((nuevaCantidad >= 0) && (idBuscar.contains("VER-")) && !(nombre.equals("N/A")) && !(precio.equals("N/A"))){
    ...
    private void poblarTablaVerduras() {
        ...
        DefaultTableModel modelo = (DefaultTableModel) tblVegetales.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_Clientes_AgregarVerduras.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_Clientes_AgregarVerduras().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel lblImagenVegetales;
    ...
    private javax.swing.JTable tblVegetales;
