 ...
 * @author jrg71
 */
public class frm_MenuPrincipal_Vendedores extends javax.swing.JFrame {

    /**
     * Creates new form frm_MenuPrincipal_Admin
     */
    public frm_MenuPrincipal_Vendedores() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_MenuPrincipal_Vendedores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_MenuPrincipal_Vendedores().setVisible(true);
            }
        });
    }
